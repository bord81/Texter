...
public class RetweetedItem {
    ...
    public RetweetedItem(String created_at, long id, String text, long in_reply_to_user_id, User user, boolean is_quote_status, int retweet_count, int favorite_count, boolean favorited, boolean retweeted) {
